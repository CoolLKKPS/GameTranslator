...
namespace GameTranslator.Patches.Hooks.texture
{
    internal static class UI2DSprite_sprite2D_Hook
    {
        ...
        private static MethodBase TargetMethod(object instance)
        {
            ...
            PropertyInfo propertyInfo = AccessToolsShim.Property((ui2DSprite != null) ? ui2DSprite.ClrType : null, "sprite2D");
        ...
        {
            UI2DSprite_sprite2D_Hook._original = detour.GenerateTrampolineEx<Action<object, object>>();
        }

        private static void MM_Detour(object __instance, object value)
        {
            UI2DSprite_sprite2D_Hook._original(__instance, value);
            UI2DSprite_sprite2D_Hook.Postfix(__instance);
        }
