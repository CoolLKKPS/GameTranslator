...
namespace GameTranslator.Patches.Hooks.texture
{
    internal static class UITexture_material_Hook
    {
        ...
        private static MethodBase TargetMethod(object instance)
        {
            ...
            PropertyInfo propertyInfo = AccessToolsShim.Property((uitexture != null) ? uitexture.ClrType : null, "material");
        ...
        {
            UITexture_material_Hook._original = detour.GenerateTrampolineEx<Action<object, object>>();
        }

        private static void MM_Detour(object __instance, object value)
        {
            UITexture_material_Hook._original(__instance, value);
            UITexture_material_Hook.Postfix(__instance);
        }
